...
export function spherical(cartesian: number[]): number[] {
  return [atan2(cartesian[1], cartesian[0]), asin(cartesian[2])]
}

export function cartesian(spherical: number[]): number[] {
...
export function cartesianCross(a: number[], b: number[]): number[] {
...
export function cartesianScale(vector: number[], k: number): number[] {
