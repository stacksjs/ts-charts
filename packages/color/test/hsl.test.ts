...
import { Color, Hsl, color, hsl, rgb } from '../src/index.ts'
import { assertHslEqual, assertRgbApproxEqual } from './asserts.ts'
...
describe('hsl', () => {
  ...
  it('hsl(h, s, l) coerces channel values to numbers', () => {
    assertHslEqual(hsl('120' as any, '.4' as any, '.5' as any), 120, 0.4, 0.5, 1)
  })

  it('hsl(h, s, l, opacity) coerces opacity to number', () => {
    assertHslEqual(hsl(120, 0.1, 0.5, '0.2' as any), 120, 0.1, 0.5, 0.2)
    assertHslEqual(hsl(120, 0.9, 0.5, '0.9' as any), 120, 0.9, 0.5, 0.9)
  })

  it('hsl(h, s, l) allows undefined channel values', () => {
    assertHslEqual(hsl(undefined as any, NaN, 'foo' as any), NaN, NaN, NaN, 1)
    assertHslEqual(hsl(undefined as any, 0.4, 0.5), NaN, 0.4, 0.5, 1)
    assertHslEqual(hsl(42, undefined as any, 0.5), 42, NaN, 0.5, 1)
    assertHslEqual(hsl(42, 0.4, undefined as any), 42, 0.4, NaN, 1)
  })

  it('hsl(h, s, l, opacity) converts undefined opacity to 1', () => {
    assertHslEqual(hsl(10, 0.2, 0.3, null as any), 10, 0.2, 0.3, 1)
