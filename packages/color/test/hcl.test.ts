...
import { Color, Hcl, color, hcl, hsl, lab, rgb } from '../src/index.ts'
import { assertHclEqual, assertRgbApproxEqual } from './asserts.ts'
...
describe('hcl', () => {
  ...
  it('hcl(h, c, l) coerces channel values to numbers', () => {
    assertHclEqual(hcl('120' as any, '40' as any, '50' as any), 120, 40, 50, 1)
  })

  it('hcl(h, c, l, opacity) coerces opacity to number', () => {
    assertHclEqual(hcl(120, 40, 50, '0.2' as any), 120, 40, 50, 0.2)
  })

  it('hcl(h, c, l) allows undefined channel values', () => {
    assertHclEqual(hcl(undefined as any, NaN, 'foo' as any), NaN, NaN, NaN, 1)
    assertHclEqual(hcl(undefined as any, 40, 50), NaN, 40, 50, 1)
    assertHclEqual(hcl(42, undefined as any, 50), 42, NaN, 50, 1)
    assertHclEqual(hcl(42, 40, undefined as any), 42, 40, NaN, 1)
  })

  it('hcl(h, c, l, opacity) converts undefined opacity to 1', () => {
    assertHclEqual(hcl(10, 20, 30, null as any), 10, 20, 30, 1)
