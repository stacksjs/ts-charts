...
describe('scaleLinear', () => {
  ...
  it('linear.invert(y) coerces range values to numbers', () => {
    ...
    expect(scaleLinear().range([new Date(1990, 0, 1), new Date(1991, 0, 1)] as any).invert(new Date(1990, 6, 2, 13) as any)).toBe(0.5)
  })
  ...
  it('linear.domain(domain) coerces domain values to numbers', () => {
    expect(scaleLinear().domain([new Date(1990, 0, 1), new Date(1991, 0, 1)] as any).domain()).toEqual([631180800000, 662716800000])
