...
function CatmullRom(this: any, context: CurveContext, alpha: number): void {
...
export default (function custom(alpha: number): CatmullRomCurveFactory {
  function catmullRom(context: CurveContext): CurveGenerator {
    return alpha ? new (CatmullRom as any)(context, alpha) : new (Cardinal as any)(context, 0)
  }

  catmullRom.alpha = function (alpha: number): CatmullRomCurveFactory {
    return custom(+alpha)
  }

  return catmullRom as CatmullRomCurveFactory
})(0.5) as CatmullRomCurveFactory
