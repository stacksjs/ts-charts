...
import { line, curveBundle } from '../../src/index.ts'
...
it('line.curve(curveBundle) uses a default beta of 0.85', () => {
  ...
  expect(line().curve(curveBundle)([[0, 1], [1, 3], [2, 1], [3, 3]])).toBe(l([[0, 1], [1, 3], [2, 1], [3, 3]]))
})
...
it('line.curve(curveBundle.beta(beta)) coerces the specified beta to a number', () => {
  const l = line().curve(curveBundle.beta('0.5' as any))
  expect(line().curve(curveBundle.beta(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]])).toBe(l([[0, 1], [1, 3], [2, 1], [3, 3]]))
})
