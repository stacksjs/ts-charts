...
import { area, line, curveMonotoneX } from '../../src/index.ts'
...
it('line.curve(curveMonotoneX)(data) ignores coincident points', () => {
  ...
  expect(l([[0, 200], [0, 200], [50, 200], [100, 100], [150, 0], [200, 0]])).toBe(p)
  expect(l([[0, 200], [50, 200], [50, 200], [100, 100], [150, 0], [200, 0]])).toBe(p)
  expect(l([[0, 200], [50, 200], [100, 100], [100, 100], [150, 0], [200, 0]])).toBe(p)
  expect(l([[0, 200], [50, 200], [100, 100], [150, 0], [150, 0], [200, 0]])).toBe(p)
  expect(l([[0, 200], [50, 200], [100, 100], [150, 0], [200, 0], [200, 0]])).toBe(p)
})
